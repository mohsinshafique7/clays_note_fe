...
function Dashboard() {
    ...
    return (<div className="grid items-start gap-y-8">
        ...
        {data.length < 1 ? (<div className="flex min-h-[400px] flex-col items-center justify-center rounded-md boarder-md boarder-dashboard p-8 text-center animate-in fade-in-50">
